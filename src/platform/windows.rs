...
pub static SAFE_COMMANDS: &[SafeCommand] = &[
    ...
    SafeCommand {
        name: "date",
        description: "Display current date and time (date /t)",
    },
    SafeCommand {
        name: "whoami",
    ...
    SafeCommand {
        name: "cd",
        description: "Print working directory (no args)",
    },
    SafeCommand {
        name: "ver",
    ...
    SafeCommand {
        name: "set",
        description: "Print environment variables (no args)",
    },
];
...
pub static PROTECTED_PATHS: &[ProtectedPath] = &[
    ...
    ProtectedPath {
        ...
        read_allowed: true,
        reason: "Windows System32",
    },
    ProtectedPath {
        path: "C:\\Windows\\SysWOW64",
        read_allowed: true,
        reason: "Windows SysWOW64",
    },
    ProtectedPath {
        path: "C:\\Program Files",
        read_allowed: true,
        reason: "Program Files",
    },
    ProtectedPath {
        path: "C:\\Program Files (x86)",
        read_allowed: true,
        reason: "Program Files (x86)",
    },
    ProtectedPath {
        path: "C:\\ProgramData",
        read_allowed: false,
        reason: "Program data directory",
    },
];
